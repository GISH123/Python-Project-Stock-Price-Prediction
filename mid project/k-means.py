...
dataset_array = pd.read_csv(r'C:\Users\User\1000_keywords_tf_idf.csv').iloc[:,1:].values

print(dataset_array.shape)
import time

t1 = time.time()
kmeans = KMeans(n_init  = 4, n_jobs  =4 , n_clusters= 8 , random_state=0).fit(dataset_array)
